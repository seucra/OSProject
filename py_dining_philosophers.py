...
=============================================================
  ...
  B.Tech Computer Engineering — Python Programming
...
=============================================================
  ...
  2. Waiter (Semaphore)  — global threading.Semaphore limits concurrency
  3. Chandy–Misra        — token-based fork passing

  Architecture:
  -------------
  - Each philosopher runs in its own daemon threading.Thread.
  - Forks are protected by threading.Lock objects.
  - The GUI (Tkinter Canvas) polls shared state every ~80 ms.
  - A thread-safe queue.Queue handles cross-thread logging.
...
class DiningGUI:
    ...
    def __init__(self, root: tk.Tk):
        self.root = root
        self.root.title("Dining Philosophers — Python Project")
    ...
    def _build_ui(self):
        ...
        tk.Label(top, text="Python Sem 4", fg="#60a5fa",
    ...
    def _schedule_poll(self):
        interval_ms = [1200, 150, 100, 70, 40][self.speed_var.get() - 1]
